function MensajeTipoSeguro() {
    var seguroSeleccionado = document.getElementById("seguro").value;
...
function Calcular() {
    ...
    document.getElementById("numeroDias").value = calculoDias("N2");
    document.getElementById("tarifaDiaria").value = tarifaDiaria("N2");
    document.getElementById("total").value = totalAPagar("N2");
